...
export default function LigasFutsal() {
  ...
  return (
    <>
      <SEO
        title="Competiciones de Fútbol Sala"
        description="Torneos y ligas de Fútbol Sala en Activa Fitness Agost. Consulta clasificaciones, resultados y horarios en tiempo real."
        canonical="/futsal"
      />
        ...
        <div className="relative z-10 w-full max-w-4xl px-4 py-8 md:py-16">
          <div className="bg-[#1e293b]/90 backdrop-blur-md border border-slate-700/50 rounded-2xl p-6 md:p-10 shadow-2xl">
            ...
            {!cargando && !error && torneos.length === 0 && (
              <p className="text-slate-400 text-sm font-bold">No hay torneos registrados aún.</p>
            )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-center md:text-left relative z-10">
                        ...
                        <span className={`text-xs uppercase tracking-widest font-black ${es24h ? 'text-amber-500' : 'text-[#60A5FA]'}`}>
                          {torneo.estado}
                        </span>
                      </div>
                      <Link
                        ...
                        } text-black px-8 py-3.5 rounded-xl font-black uppercase tracking-widest transition-all w-full md:w-auto text-center relative z-10`}
                      >
                        Ver Competición
                      </Link>
                    </div>
