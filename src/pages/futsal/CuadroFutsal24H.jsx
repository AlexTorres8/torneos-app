...
const ESQ_CUARTOS = [
  { id:'c1', hora:'04:00', ubicacion:'Pabellón', estado:'pendiente', local:{nombre:'1º Grupo A'}, visitante:{nombre:'Mejor 3º'}   },
  { id:'c2', hora:'04:00', ubicacion:'Pista',    estado:'pendiente', local:{nombre:'2º Grupo C'}, visitante:{nombre:'2º Mejor 3º'} },
  { id:'c3', hora:'05:00', ubicacion:'Pabellón', estado:'pendiente', local:{nombre:'1º Grupo B'}, visitante:{nombre:'2º Mejor 3º'} },
  { id:'c4', hora:'05:00', ubicacion:'Pista',    estado:'pendiente', local:{nombre:'1º Grupo C'}, visitante:{nombre:'2º Grupo A'} },
];
const ESQ_SEMIS = [
  { id:'s1', hora:'07:00', ubicacion:'Pabellón', estado:'pendiente', local:{nombre:'Ganador 04:00 (1)'}, visitante:{nombre:'Ganador 05:00 (1)'} },
  { id:'s2', hora:'07:00', ubicacion:'Pista',    estado:'pendiente', local:{nombre:'Ganador 04:00 (2)'}, visitante:{nombre:'Ganador 05:00 (2)'} },
];
const ESQ_FINAL = [{ id:'f1', hora:'09:00', ubicacion:'Pabellón', estado:'pendiente', local:{nombre:'Ganador Semi 1'}, visitante:{nombre:'Ganador Semi 2'} }];
...
export default function CuadroFutsal24H() {
  ...
  const rondas = [
    { label: 'Cuartos (04:00-05:00)', partidos: cuartos.length > 0 ? cuartos : ESQ_CUARTOS },
    { label: 'Semifinales (07:00)',    partidos: semis.length   > 0 ? semis   : ESQ_SEMIS   },
    { label: 'Gran Final (09:00)',     partidos: finales.length > 0 ? finales : ESQ_FINAL   },
  ];
    ...
    <div className="max-w-7xl mx-auto pb-20 px-4">
      ...
      <div className="space-y-24">
        ...
        <section>
          ...
          {cargando
            ? <Skeleton.Bracket rondas={3} partidosPorRonda={[4,2,1]} />
