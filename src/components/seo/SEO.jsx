...
const BASE       = 'Activa Fitness Agost';
...
export function SEO({ title, description = BASE_DESC, image = BASE_IMAGE, noindex = false, canonical }) {
  const fullTitle = title ? `${title} · ${BASE}` : `${BASE} · Torneos de Fútbol Sala y Pádel`;
